...
/**
 * @file writer_txt.hpp
 * @brief Definition of a Writer class for .txt files.
 */
...
/**
 * @class WriterTXT
 * @brief Class representing a file writer for txt format.
 */
class WriterTXT : public Writer {
    public:
         ...
         */
        WriterTXT(std::string _filename, std::string _filetype);
